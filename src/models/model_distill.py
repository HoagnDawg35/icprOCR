...
from src.models.necks import STNBlock, AttentionFusion, PositionalEncoding, ResBlock, MultiHeadCA

class ResTranOCR_Distill(nn.Module):
    """
    ResTranOCR modified for Knowledge Distillation.
    Can return intermediate features for L2 loss.
    """
    def __init__(
        self,
        num_classes: int,
    ...
    def forward(self, x: torch.Tensor, return_feats: bool = False) -> torch.Tensor:
        ...
        Args:
            ...
            return_feats: If True, returns (logits, features_dict)
        Returns:
